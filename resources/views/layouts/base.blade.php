    ...
    <nav class="bg-gray-900 relative text-white text-2xl py-4 px-2">
        <div class="container max-w-screen-xl mx-auto flex flex-wrap justify-between items-center">
            ...
            <ul class="flex flex-row gap-1 md:order-2">
                ...
                <a href="https://www.youtube.com/channel/UCoPZwSoP3WqyiILInzpvIkQ" target="_blank"
            ...
            <ul id="menu"
                ...
                <li><a href="{{ route('programacion') }}"
                        class="text-slate-400 hover:text-slate-50 {{ request()->routeIs('programacion') ? 'text-slate-50 font-medium' : '' }}">Programación</a>
                </li>
                <li><a href="{{ route('programas') }}"
                        class="text-slate-400 hover:text-slate-50 {{ request()->routeIs('programas') ? 'text-slate-50 font-medium' : '' }}">Programas</a>
                </li>
                <li><a href="{{ route('contactos') }}"
                        class="text-slate-400 hover:text-slate-50 {{ request()->routeIs('contactos') ? 'text-slate-50 font-medium' : '' }}">Contactos</a>
                </li>
            </ul>
    ...
    <main class="container max-w-screen-xl mx-auto my-6 lg:flex lg:flex-row">
        ...
        <div class="lg:basis-2/6">
            ...
            <div class="flex flex-col gap-2 m-4 p-4 shadow-xl rounded-xl overflow-hidden">
                ...
                <picture class="w-3/5 h-24 mx-auto sm:w-2/4 md:w-2/5 lg:w-3/5">
                    <img loading="lazy" src="{{ asset('assets/bot-evangelio-vida.jpg') }}" alt=""
                        class="w-full h-full">
                </picture>
                <picture class="w-3/5 h-24 mx-auto sm:w-2/4 md:w-2/5 lg:w-3/5">
                    <img loading="lazy" src="{{ asset('assets/Protagonistas.jpg') }}" alt=""
                        class="w-full h-full">
                </picture>
                <picture class="w-3/5 h-24 mx-auto sm:w-2/4 md:w-2/5 lg:w-3/5">
            ...
            <div class="">
                ...
                <a href="https://www.youtube.com/channel/UCoPZwSoP3WqyiILInzpvIkQ" target="_blank"
                    rel="noopener noreferrer" class="block text-xl hover:text-red-700"><i
                        class="fa-brands fa-youtube w-6 h-6 mr-2"></i>You
                    tube</a>
                <a href="https://twitter.com/CTV_Bolivia" target="_blank" rel="noopener noreferrer"
